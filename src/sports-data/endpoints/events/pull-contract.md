...
| marketGroups | Specifies the market groups defined within the event. | MarketGroup | Yes | query (using lambda, eq, ne, or, and, in) </br> Сan't query this together with marketTypes.| $filter=marketGroups/any(p: p/name eq 'Corners') |
